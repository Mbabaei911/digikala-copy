...
function RegisterModalForHomePage({ modals, setModals }) {
  ...
  return (
    <Fragment>
      <div className="w-screen h-screen bg-white fixed  flex items-center  justify-center z-[61]">
        <div
          onClick={() => {
...
function RegisterModalForShoppingPage({
  showRegisterModal,
...
export { RegisterModalForHomePage, RegisterModalForShoppingPage };
